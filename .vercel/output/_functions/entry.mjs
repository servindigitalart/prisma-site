...
import { manifest } from './manifest_S1yxKAbS.mjs';
...
const _page30 = () => import('./pages/festivals/_slug_.astro.mjs');
const _page31 = () => import('./pages/festivals.astro.mjs');
const _page32 = () => import('./pages/ficha/_token_.astro.mjs');
const _page33 = () => import('./pages/films/_slug_.astro.mjs');
const _page34 = () => import('./pages/people/_slug_.astro.mjs');
const _page35 = () => import('./pages/people.astro.mjs');
const _page36 = () => import('./pages/rankings/films.astro.mjs');
const _page37 = () => import('./pages/ritmo/_slug_.astro.mjs');
const _page38 = () => import('./pages/share/_work_id_.astro.mjs');
const _page39 = () => import('./pages/studios/_slug_.astro.mjs');
const _page40 = () => import('./pages/submit.astro.mjs');
const _page41 = () => import('./pages/temperatura/_slug_.astro.mjs');
const _page42 = () => import('./pages/u/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/festivals/[slug].astro", _page30],
    ["src/pages/festivals/index.astro", _page31],
    ["src/pages/ficha/[token].astro", _page32],
    ["src/pages/films/[slug].astro", _page33],
    ["src/pages/people/[slug].astro", _page34],
    ["src/pages/people/index.astro", _page35],
    ["src/pages/rankings/films.astro", _page36],
    ["src/pages/ritmo/[slug].astro", _page37],
    ["src/pages/share/[work_id].astro", _page38],
    ["src/pages/studios/[slug].astro", _page39],
    ["src/pages/submit.astro", _page40],
    ["src/pages/temperatura/[slug].astro", _page41],
    ["src/pages/u/[id].astro", _page42],
...
const _args = {
    "middlewareSecret": "a479f896-b646-4840-9363-5d6610ec2da1",
