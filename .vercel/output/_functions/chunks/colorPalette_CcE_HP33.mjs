...
function isLightColor(colorId) {
  const LIGHT_COLORS = /* @__PURE__ */ new Set(["amarillo_ludico", "verde_lima", "blanco_polar", "rosa_pastel"]);
...
export { PRISMA_PALETTE as P, formatRole as f, getPaletteEntry as g, isLightColor as i };
