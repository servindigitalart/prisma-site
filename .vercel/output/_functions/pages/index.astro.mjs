...
PRISMA maps the visual DNA of cinema through an 18-color emotional palette —
  ...
  })} </div> </div> </section>`} ${featuredColors.length > 0 && renderTemplate`<section class="home-colors" data-astro-cid-j7pv25f6> <div class="site-container" data-astro-cid-j7pv25f6> <div class="home-colors__header" data-astro-cid-j7pv25f6> <h2 class="home-colors__heading" data-astro-cid-j7pv25f6>Explore the palette</h2> <a href="/colors" class="home-colors__see-all" data-astro-cid-j7pv25f6>All 18 colors →</a> </div> <div class="home-colors__grid" data-astro-cid-j7pv25f6> ${featuredColors.map((color) => {
...
Color is not decoration.<br data-astro-cid-j7pv25f6>It is argument.
</h2> <div class="home-manifesto__body" data-astro-cid-j7pv25f6> <p data-astro-cid-j7pv25f6>
The Prisma palette is a deliberate rejection of pixel-counting. Color identity
            in cinema is determined by what an audience carries away — the bruised red of a
            final confrontation, the cold blue of an all-night diner, the suffused yellow
            of a remembered childhood.
</p> <p data-astro-cid-j7pv25f6>
Our 18-color system maps the emotional register of cinema's visual language.
            Not what is most frequent on screen, but what is most true.
</p> </div> <a href="/colors" class="home-manifesto__link" data-astro-cid-j7pv25f6>Read the doctrine →</a> </div> </div> </section> ` }));
