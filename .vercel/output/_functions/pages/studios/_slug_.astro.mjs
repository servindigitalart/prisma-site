...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": pageTitle, "data-astro-cid-anxbl64p": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="studio-page page-enter" data-astro-cid-anxbl64p> <!-- ── Header ── --> <section class="studio-header" data-astro-cid-anxbl64p> <div class="site-container" data-astro-cid-anxbl64p> <div class="studio-header__inner" data-astro-cid-anxbl64p> <!-- Logo or monogram --> <div class="studio-header__logo-wrap" data-astro-cid-anxbl64p> ${logoUrl ? renderTemplate`<img${addAttribute(logoUrl, "src")} alt="" class="studio-header__logo" loading="eager" data-astro-cid-anxbl64p>` : renderTemplate`<div class="studio-header__monogram" aria-hidden="true" data-astro-cid-anxbl64p>${monogram}</div>`} ${flag && renderTemplate`<span class="studio-header__flag" aria-hidden="true" data-astro-cid-anxbl64p>${flag}</span>`} </div> <div class="studio-header__info" data-astro-cid-anxbl64p> <p class="studio-header__overline" data-astro-cid-anxbl64p>Production Studio</p> <h1 class="studio-header__name" data-astro-cid-anxbl64p>${studio.name}</h1> <div class="studio-header__meta" data-astro-cid-anxbl64p> ${countryName && renderTemplate`<span class="studio-header__meta-item" data-astro-cid-anxbl64p>${countryName}</span>`} ${studio.founded_year && renderTemplate`<span class="studio-header__meta-item" data-astro-cid-anxbl64p>Est. ${studio.founded_year}</span>`} ${films.length > 0 && renderTemplate`<span class="studio-header__meta-item" data-astro-cid-anxbl64p> ${films.length} ${films.length === 1 ? "film" : "films"} in catalog
</span>`} </div> </div> </div> </div> </section> ${films.length === 0 ? renderTemplate`<section class="studio-empty" data-astro-cid-anxbl64p> <div class="site-container" data-astro-cid-anxbl64p> <p class="studio-empty__text" data-astro-cid-anxbl64p>No films in the catalog for this studio yet.</p> </div> </section>` : renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-anxbl64p": true }, { "default": async ($$result3) => renderTemplate`  ${topFilms.length > 0 && renderTemplate`<section class="studio-posters" data-astro-cid-anxbl64p> <div class="site-container" data-astro-cid-anxbl64p> <div class="sect-label" data-astro-cid-anxbl64p>Top Films</div> <div class="poster-row" data-astro-cid-anxbl64p> ${topFilms.map((film, i) => {
