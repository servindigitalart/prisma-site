...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": `${festival.name} \u2014 PRISMA`, "description": festival.description ?? `${festival.name} \u2014 films and awards in the PRISMA catalog.`, "data-astro-cid-7rwoky4j": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="festival-page page-enter" data-astro-cid-7rwoky4j> <!-- ── Header ── --> <section class="fest-header" data-astro-cid-7rwoky4j> <div class="site-container" data-astro-cid-7rwoky4j> <div class="fest-header__inner" data-astro-cid-7rwoky4j> <div class="fest-header__logo-wrap" data-astro-cid-7rwoky4j> ${festLogoUrl ? renderTemplate`<img${addAttribute(festLogoUrl, "src")} alt=""${addAttribute(`fest-header__logo${festLogoIsLocal ? " festival-logo--local" : ""}`, "class")} loading="eager" data-astro-cid-7rwoky4j>` : renderTemplate`<div class="fest-header__monogram" aria-hidden="true" data-astro-cid-7rwoky4j>${festMonogram}</div>`} <span class="fest-header__flag" aria-hidden="true" data-astro-cid-7rwoky4j>${flag}</span> </div> <div class="fest-header__info" data-astro-cid-7rwoky4j> <div class="fest-header__overline" data-astro-cid-7rwoky4j> ${festival.city && renderTemplate`<span data-astro-cid-7rwoky4j>${festival.city}</span>`} ${festival.city && countryName && renderTemplate`<span aria-hidden="true" data-astro-cid-7rwoky4j>·</span>`} ${countryName && renderTemplate`<span data-astro-cid-7rwoky4j>${countryName}</span>`} ${festival.founded_year && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-7rwoky4j": true }, { "default": async ($$result3) => renderTemplate` <span aria-hidden="true" data-astro-cid-7rwoky4j>·</span> <span data-astro-cid-7rwoky4j>est. ${festival.founded_year}</span> ` })}`} ${festival.tier && renderTemplate`<span class="fest-tier-badge" data-astro-cid-7rwoky4j>[${festival.tier}]</span>`} </div> <h1 class="fest-header__title" data-astro-cid-7rwoky4j>${festival.name}</h1> ${festival.name_local && festival.name_local !== festival.name && renderTemplate`<p class="fest-header__local" data-astro-cid-7rwoky4j>${festival.name_local}</p>`} ${festival.description && renderTemplate`<p class="fest-header__desc" data-astro-cid-7rwoky4j>${festival.description}</p>`} <div class="fest-header__links" data-astro-cid-7rwoky4j> ${festival.website && renderTemplate`<a${addAttribute(festival.website, "href")} target="_blank" rel="noopener noreferrer" class="fest-website-link" data-astro-cid-7rwoky4j>
Official website ↗
</a>`} </div> </div> </div> <!-- Stats bar --> ${rows.length > 0 && renderTemplate`<div class="fest-stats" data-astro-cid-7rwoky4j> <span class="fest-stat" data-astro-cid-7rwoky4j><strong data-astro-cid-7rwoky4j>${totalWins}</strong> wins in catalog</span> <span class="fest-stat-sep" aria-hidden="true" data-astro-cid-7rwoky4j>·</span> <span class="fest-stat" data-astro-cid-7rwoky4j><strong data-astro-cid-7rwoky4j>${totalNoms}</strong> nominations</span> <span class="fest-stat-sep" aria-hidden="true" data-astro-cid-7rwoky4j>·</span> <span class="fest-stat" data-astro-cid-7rwoky4j><strong data-astro-cid-7rwoky4j>${uniqueFilms.size}</strong> films</span> </div>`} </div> </section> ${rows.length === 0 ? renderTemplate`<div class="site-container fest-empty" data-astro-cid-7rwoky4j> <p data-astro-cid-7rwoky4j>No films from this festival in the catalog yet.</p> </div>` : renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-7rwoky4j": true }, { "default": async ($$result3) => renderTemplate`  ${topWinners.length > 0 && renderTemplate`<section class="fest-posters" data-astro-cid-7rwoky4j> <div class="site-container" data-astro-cid-7rwoky4j> <div class="sect-label" data-astro-cid-7rwoky4j>Winners in Catalog</div> <div class="poster-row" data-astro-cid-7rwoky4j> ${topWinners.map((r, i) => {
